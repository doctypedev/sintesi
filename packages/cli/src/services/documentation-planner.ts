    ...
    async createPlan(
        ...
        if (aiAgents.researcher) {
            ...
            try {
                ...
                const architecturalBrief = await aiAgents.researcher.generateText(discoveryPrompt, {
                    maxTokens: 2000,
                    temperature: 0.2,
                    metadata: {
                        step: 'architectural-brief',
                        'x-step-name': 'Architectural Discovery',
                    },
                });
...
`;
        ...
        try {
            let response = await aiAgents.planner.generateText(planPrompt, {
                ...
                temperature: 0.1,
                metadata: {
                    step: 'documentation-planning',
                    'x-step-name': 'Documentation Planning',
                },
            });
