...
- **PROTECT CLI FLAGS**: If updating, PRESERVE existing CLI flags (e.g. --no-strict) in usage examples unless you have proof they are removed. Assume implicit framework flags are valid.
