...
describe('ASTAnalyzer', () => {
    ...
    describe('analyzeCode', () => {
      ...
      `;
            ...
            expect(signatures[0].signatureText).toBe(signatures[0].signatureText.trim());
        });
    ...
    describe('analyzeFile', () => {
        it('should analyze a file with simple functions', () => {
            const filePath = path.resolve(__dirname, 'fixtures/simple-functions.ts');
        ...
        it('should analyze a file with types and interfaces', () => {
            const filePath = path.resolve(__dirname, 'fixtures/types-and-interfaces.ts');
