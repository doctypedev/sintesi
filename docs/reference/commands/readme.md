...
#### Usage Examples
```bash
npx sintesi check -- --verbose --base main
npx sintesi check -- --readme --no-strict --verbose
npx sintesi check -- --documentation --no-strict --verbose
```
...
#### Usage Examples
```bash
npx sintesi readme -- --output README.md --force
```
...
#### Usage Examples
```bash
npx sintesi changeset -- --base-branch main --staged-only
npx sintesi changeset -- --skip-ai --version-type minor --description "New feature"
```
...
#### Usage Examples
```bash
npx sintesi documentation -- --output-dir docs --verbose --force
```
